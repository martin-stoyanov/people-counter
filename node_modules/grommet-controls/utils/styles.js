...
exports.inputStyle = exports.focusStyle = exports.edgeStyle = exports.baseStyle = exports.backgroundStyle = exports.activeStyle = exports.colorCss = undefined;
...
var colorCss = exports.colorCss = function colorCss(color) {
  return (0, _styledComponents.css)(['color:', ';svg{stroke:', ';fill:', ';transition:none;};'], color, color, color);
};
...
var activeStyle = exports.activeStyle = (0, _styledComponents.css)(['background-color:', ';', ''], function (props) {
  ...
  return colorCss(props.theme.global.hover.textColor);
});
...
var backgroundStyle = exports.backgroundStyle = function backgroundStyle(background, theme) {
  if ((typeof background === 'undefined' ? 'undefined' : _typeof(background)) === 'object') {
    if (background.image) {
      ...
      return (0, _styledComponents.css)(['background:', ' no-repeat;background-position:', ';background-size:cover;', ''], background.image, background.position || 'center center', colorCss(color));
      ...
      if (rgba) {
        return (0, _styledComponents.css)(['background-color:', ';', ''], rgba, colorCss((0, _colors.colorIsDark)(rgba) ? theme.global.colors.darkBackground.text : theme.global.colors.text));
      }
    } else if (background.dark === false) {
      return (0, _styledComponents.css)(['color:', ';'], theme.global.colors.text);
    } else if (background.dark) {
      return (0, _styledComponents.css)(['', ';'], colorCss(theme.global.colors.darkBackground.text));
    }
    return undefined;
  }
  if (background) {
    ...
    if (_color2) {
      return (0, _styledComponents.css)(['background-color:', ';', ''], _color2, colorCss((0, _colors.colorIsDark)(_color2) ? theme.global.colors.darkBackground.text : theme.global.colors.text));
    }
  }
  return undefined;
};
