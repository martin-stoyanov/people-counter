...
var _StyledDropInput2 = _interopRequireDefault(_StyledDropInput);
  ...
  DropInput.prototype.render = function render() {
    ...
    if (numWidgets > 0) {
      ...
      decorations = _react2.default.createElement(
        ...
        widgets.map(function (widget, index) {
          return _react2.default.createElement(_grommet.Button, _extends({ tabIndex: '-1', key: 'widget_' + index }, widget));
        }),
        drop
      );
    }
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_StyledDropInput2.default, _extends({
...
DropInput.defaultProps = {
  ...
  dropIcon: _react2.default.createElement(_grommetIcons.FormDown, null),
  type: 'text',
  widgets: []
};
...
if (process.env.NODE_ENV !== 'production') {
  (0, _doc2.default)(DropInput);
}

exports.default = (0, _recompose.compose)(_hocs.withTheme)(DropInput);