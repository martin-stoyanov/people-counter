...
exports.default = function (Element) {
  ...
  DocumentedElement.propTypes = {
    kind: _reactDesc.PropTypes.oneOf(['circle', 'pulse', 'three-bounce', 'cube-grid', 'wave', 'folding-cube', 'double-bounce', 'wandering-cubes', 'chasing-dots', 'rotating-plane']).description('Kind of spinner.').isRequired.defaultValue('circle'),
