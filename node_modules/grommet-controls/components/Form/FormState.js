...
var FormState = function FormState(fields) {
  var _this = this;
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getErrors = function () {
    var errors = {};
    var addError = function addError(key, label, message) {
      if (!errors[key]) {
        errors[key] = [];
      }
      var msg = void 0;
      ...
      if (rules) {
        ...
        var _loop = function _loop(i) {
          ...
          if (typeof rule === 'function') {
            var value = _this2.proxyObj[key];
            if (Array.isArray(value)) {
              var arrayErrors = [];
              value.forEach(function (v, index) {
                var message = rule(_this2.proxyObj, _this2.proxyObj[key], index);
                if (message) {
              ...
              var message = rule(_this2.proxyObj, _this2.proxyObj[key]);
              if (message) {
            ...
            if (rule.rule && typeof rule.rule === 'function') {
              var isValid = rule.rule(_this2.proxyObj, _this2.proxyObj[key]);
              if (!isValid) {
  ...
  this.isValid = function () {
    return !Object.keys(_this2.getErrors()).length;
  };
};
