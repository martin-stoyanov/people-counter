...
exports.default = function (WrappedField) {
  var _class, _temp2;
  ...
  return _temp2 = _class = function (_React$Component) {
    ...
    function GrommetField() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.onChange = function (_ref) {
    ...
    GrommetField.prototype.componentDidMount = function componentDidMount() {
      ...
      this.context.form.attachToForm(name, { label: label, validation: validation });
    };
    ...
    GrommetField.prototype.render = function render() {
      var _props2 = this.props,
          ...
          label = _props2.label,
          other = _objectWithoutProperties(_props2, ['name', 'validation', 'label']);
      ...
      return _react2.default.createElement(
        _grommet.FormField,
        { htmlFor: name, label: label || name, error: error },
        _react2.default.createElement(WrappedField, _extends({
          plain: true,
          id: name,
          name: name,
          value: this.getValue(),
