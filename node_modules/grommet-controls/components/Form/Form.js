...
var Form = function (_Component) {
  ...
  function Form(props, context) {
    ...
    _this.config = {};
    var formState = new _FormState2.default(_this.config, props.object, function () {
  ...
  Form.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    if (nextProps.object) {
      this.setState({ object: _extends({}, this.state.object, nextProps.object) });
    }
  };
  ...
  Form.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        tag = _props.tag,
        rest = _objectWithoutProperties(_props, ['children', 'a11yTitle', 'tag']);

    var StyledComponent = styledComponents[tag];
    if (!StyledComponent) {
      StyledComponent = _StyledForm2.default.withComponent(tag);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.updateObject = function (name, value) {
