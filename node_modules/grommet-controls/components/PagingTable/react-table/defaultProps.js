...
var _TableComponent = require('../components/TableComponent');
...
var _TheadComponent = require('../components/TheadComponent');

var _TheadComponent2 = _interopRequireDefault(_TheadComponent);

var _TbodyComponent = require('../components/TbodyComponent');

var _TbodyComponent2 = _interopRequireDefault(_TbodyComponent);

var _TfootComponent = require('../components/TfootComponent');

var _TfootComponent2 = _interopRequireDefault(_TfootComponent);

var _NoDataComponent = require('../components/NoDataComponent');

var _NoDataComponent2 = _interopRequireDefault(_NoDataComponent);

var _ResizerComponent = require('../components/ResizerComponent');

var _ResizerComponent2 = _interopRequireDefault(_ResizerComponent);

var _ThComponent = require('../components/ThComponent');

var _ThComponent2 = _interopRequireDefault(_ThComponent);

var _TdComponent = require('../components/TdComponent');

var _TdComponent2 = _interopRequireDefault(_TdComponent);

var _CellTextComponent = require('../components/CellTextComponent');

var _CellTextComponent2 = _interopRequireDefault(_CellTextComponent);

var _FilterComponent = require('../components/FilterComponent');

var _FilterComponent2 = _interopRequireDefault(_FilterComponent);

var _ExpanderComponent = require('../components/ExpanderComponent');
...
var _TrGroupComponent = require('../components/TrGroupComponent');

var _TrGroupComponent2 = _interopRequireDefault(_TrGroupComponent);

var _TrComponent = require('../components/TrComponent');
...
exports.default = {
  ...
  getTrProps: function getTrProps(even, _ref8) {
    ...
    if (decorations) {
      return (even ? decorations.rowEven || defaultRowEvenProps : decorations.rowOdd || defaultRowOddProps) || decorations.row || defaultRowProps;
    }
