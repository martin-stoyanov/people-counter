...
var NumberInput = function (_Component) {
  ...
  function NumberInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.valueToNumber = function (value) {
      ...
      return (0, _MaskedInput.maskedNumberValue)({
  ...
  NumberInput.prototype.render = function render() {
    ...
    var mask = userMask || (0, _MaskedInput.createNumberMask)({
      prefix: prefix,
      suffix: suffix,
    ...
    var pipe = userPipe || (0, _MaskedInput.createMinMaxInputPipe)(_extends({
...
NumberInput.defaultProps = {
  emptyValue: '',
  step: 1,
  addIcon: _react2.default.createElement(_grommetIcons.Add, null),
  subtractIcon: _react2.default.createElement(_grommetIcons.Subtract, null),
  prefix: '',
  suffix: '',
