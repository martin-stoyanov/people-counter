...
var Select = function (_Component) {
  ...
  Select.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        value = _props.value,
        label = _props.label,
        rest = _objectWithoutProperties(_props, ['a11yTitle', 'children', 'disabled', 'dropAlign', 'dropTarget', 'messages', 'onChange', 'onClose', 'placeholder', 'plain', 'size', 'theme', 'value', 'label']);
    ...
    if (!_react2.default.isValidElement(value)) {
      if (typeof label === 'function') {
        selectValue = label({ placeholder: placeholder, value: value, onChange: onChange });
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          selectValue || _react2.default.createElement(_grommet.TextInput, _extends({
