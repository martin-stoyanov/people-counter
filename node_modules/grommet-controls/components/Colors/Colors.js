...
var _StyledColors2 = _interopRequireDefault(_StyledColors);
...
var Colors = function (_Component) {
  ...
  Colors.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        size = _props.size,
        theme = _props.theme,
        rest = _objectWithoutProperties(_props, ['wrap', 'column', 'disabled', 'onSelect', 'columns', 'size', 'theme']);
    ...
    var cellSize = (0, _utils.parseMetricToNum)(theme.calendar[size].daySize);
    var colors = colorRows.map(function (row, rowIndex) {
      return _react2.default.createElement(
        _StyledColors.StyledRow,
        { key: 'row_' + rowIndex, theme: theme, style: { width: cellSize * row.colors.length + 'px', height: cellSize + 'px' } },
        row.colors.map(function (color, colorIndex) {
          var isActive = activeRow === rowIndex && activeColor === colorIndex;
          var colorStyle = {
            backgroundColor: color.color,
            color: (0, _colors.colorIsDark)(color.color) ? theme.global.colors.darkBackground.text : theme.global.colors.text,
...
if (process.env.NODE_ENV !== 'production') {
  (0, _doc2.default)(Colors);
}

exports.default = (0, _recompose.compose)(_hocs.withTheme)(Colors);