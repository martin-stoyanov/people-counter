...
var DropInput = function (_Component) {
  ...
  DropInput.prototype.render = function render() {
    ...
    if (numWidgets > 0) {
      ...
      decorations = React.createElement(
        ...
        widgets.map(function (widget, index) {
          return React.createElement(Button, _extends({ tabIndex: '-1', key: 'widget_' + index }, widget));
        }),
        drop
      );
    }
    return React.createElement(
      ...
      React.createElement(
        ...
        null,
        React.createElement(StyledDropInput, _extends({
...
export default compose(withTheme)(DropInput);