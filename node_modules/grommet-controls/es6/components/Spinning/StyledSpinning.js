...
var animationFadeIn = keyframes(['0%{opacity:0;}50%{opacity:0;}100%{opacity:1;}']);

var animationBounceDelay = keyframes(['0%,80%,100%{-webkit-transform:scale(0.0)}40%{-webkit-transform:scale(1.0)}']);

var animationScaleDelay = keyframes(['0%,70%,100%{-webkit-transform:scale3D(1.0,1.0,1.0)}35%{-webkit-transform:scale3D(0.0,0.0,1.0)}']);

var animationStretchDelay = keyframes(['0%,40%,100%{-webkit-transform:scaleY(0.4)}20%{-webkit-transform:scaleY(1.0)}']);

var animationFoldCubeAngle = keyframes(['0%,10%{-webkit-transform:perspective(140px) rotateX(-180deg);opacity:0;}25%,75%{-webkit-transform:perspective(140px) rotateX(0deg);opacity:1;}90%,100%{-webkit-transform:perspective(140px) rotateY(180deg);opacity:0;}']);

var animationBounce = keyframes(['0%,100%{-webkit-transform:scale(0.0);}50%{-webkit-transform:scale(1.0);}']);

var animationCubeMove = keyframes(['25%{-webkit-transform:translateX(42px) rotate(-90deg) scale(0.5);}50%{-webkit-transform:translateX(42px) translateY(42px) rotate(-179deg);}50.1%{-webkit-transform:translateX(42px) translateY(42px) rotate(-180deg);}75%{-webkit-transform:translateX(0px) translateY(42px) rotate(-270deg) scale(0.5);}100%{-webkit-transform:rotate(-360deg);}']);

var animationRotate = keyframes(['100%{-webkit-transform:rotate(360deg)}']);

var animationRotatePlane = keyframes(['0%{-webkit-transform:perspective(120px) rotateX(0deg) rotateY(0deg);}50%{-webkit-transform:perspective(120px) rotateX(-180.1deg) rotateY(0deg);}100%{-webkit-transform:perspective(120px) rotateX(-180deg) rotateY(-179.9deg);}']);

var animationScaleOut = keyframes(['0%{-webkit-transform:scale(0.0)}100%{-webkit-transform:scale(1.0);opacity:0;}']);

var animationInnerCircle = keyframes(['0%{-webkit-transform:rotate(0);}100%{-webkit-transform:rotate(360deg);}']);

export var ThreeBounceSpinner = styled.div.withConfig({
...
export var CircleSpinner = styled.div.withConfig({
...
export var CubeGridSpinner = styled.div.withConfig({
...
export var WaveSpinner = styled.div.withConfig({
...
export var FoldingCubeSpinner = styled.div.withConfig({
...
export var DoubleBounceSpinner = styled.div.withConfig({
...
export var WanderingCubesSpinner = styled.div.withConfig({
...
export var ChasingDotsSpinner = styled.div.withConfig({
...
export var RotatingPlaneSpinner = styled.div.withConfig({
...
export var PulseSpinner = styled.div.withConfig({
...
export var WordPressSpinner = styled.div.withConfig({
