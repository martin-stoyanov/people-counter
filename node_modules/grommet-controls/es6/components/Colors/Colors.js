  ...
  Colors.prototype.componentDidUpdate = function componentDidUpdate() {
    if (this.setFocus) {
      ...
      if (colorRows[activeRow] && colorRows[activeRow].colors[activeColor] && colorRows[activeRow].colors[activeColor].buttonRef) {
        var buttonNode = findDOMNode(colorRows[activeRow].colors[activeColor].buttonRef);
        if (buttonNode) {
      ...
      return React.createElement(
        ...
        row.colors.map(function (color, colorIndex) {
          ...
          var colorStyle = {
            ...
            color: colorIsDark(color.color) ? theme.global.colors.darkBackground.text : theme.global.colors.text,
...
export default compose(withTheme)(Colors);