...
export default (function (Element) {
  var DocumentedElement = describe(Element).description('A Form with built-in validation.\n      ').usage('\n      $ npm install grommet-controls\n \n      import { Form } from \'grommet-controls\';\n\n      <Form onSubmit={...} />\n    ');

  DocumentedElement.propTypes = {
    a11yTitle: a11yTitlePropType,
    basis: PropTypes.oneOf(['xsmall', 'small', 'medium', 'large', 'xlarge', 'full', '1/2', '1/3', '2/3', '1/4', '3/4', 'auto']).description('A fixed or relative size along the form\'s container main axis.'),
