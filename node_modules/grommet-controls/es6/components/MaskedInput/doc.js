...
export default (function (Element) {
  var DocumentedElement = describe(Element).description('A masked Input control with an optional drop button with the specified \'dropContent\'.').usage('\n    $ npm install grommet-controls\n\n    import { MakedInput } from \'grommet-controls\';\n\n    <MakedInput mask={...} />\n    ');

  DocumentedElement.propTypes = {
    a11yTitle: a11yTitlePropType,
    a11yDropTitle: PropTypes.string.description('Custom drop button title to be used by screen readers.'),
    ...
    keepCharPositions: PropTypes.bool.description('For masked. When true, adding or deleting characters will not affect the positions of existing characters.\n      When false, adding characters causes existing characters to advance. And deleting characters causes existing characters to move back.'),
