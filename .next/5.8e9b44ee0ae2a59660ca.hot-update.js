...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "onAddDrink", {
      ...
      writable: true,
      value: function value() {
        var name = document.getElementById("drinker").value;
        console.log(document.getElementById("drinker").value);
...
//# sourceMappingURL=5.8e9b44ee0ae2a59660ca.hot-update.js.map